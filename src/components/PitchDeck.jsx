...
const PitchDeck = ({ onClose }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: 'От одной кофейни до международной сети',
      content: (
        <ul className="pitch-list">
          <li>☁️ <b>Cloud-Ready:</b> Перенос архитектуры на Firebase/Supabase.</li>
          <li>⚡️ <b>Real-time:</b> Интеграция с WebSockets для мгновенной передачи заказов.</li>
          <li>🖨 <b>Hardware:</b> Подключение фискальных регистраторов и терминалов.</li>
        </ul>
      ),
      accent: '#f43f5e'
    },
